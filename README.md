...
[Jon Ursenbach](https://github.com/erunion) - Built out an [OpenAPI 3 spec](https://github.com/erunion/sport-api-specifications) for the NHL API <!-- AUTO-GENERATED-CONTENT:START (STARTER) -->
<p align="center">
