...
describe('Game', () => {
    it('Creating Valid Regulation Game', () => {
        const dummyGameData = require("../../../__test_data__/unit/data/dummy-game.json");
    ...
    it('Creating Valid Overtime Game', () => {
        const dummyGameData = require("../../../__test_data__/unit/data/dummy-ot-game.json");
    ...
    it('Creating Valid Shootout Game', () => {
        const dummyGameData = require("../../../__test_data__/unit/data/dummy-so-game.json");
        const game = new Game(dummyGameData);
